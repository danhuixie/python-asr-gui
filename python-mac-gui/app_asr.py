...
class ASRClient:
    def __init__(self, app_id, app_secret, host="wss://127.0.0.1:8072", call_back=None, call_back_par=None):
        ...
        self.call_back_par = call_back_par
            ...
            while True:
                ...
                if ok and result is not None:
                    if self.call_back is not None:
                        self.call_back(result, self.call_back_par)
